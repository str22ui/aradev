<div class="mx-5 mt-2 md:mt-24 mb-10  ">
    ...
    <div class="md:mb-10 text-center pt-18">
        ...
        <h2 class="text-xl font-bold mt-6 text-blue-700 "> Janjian Survey<label for=""
                class="text-blue-900 uppercase"> [
    ...
    <form method="POST" action="/survey/store/{{ $selectedPerumahan->id }}"
        ...
        <div class="text-blue-700 mx-5  ">
            ...
            <div class="mb-5 relative">
                <label for="nama_konsumen" class="form-label block mb-2 text-sm font-medium"> <i
                        class="fas fa-user text-gray-400 mr-2"></i>Nama</label>
            ...
            <div class="mb-5 relative">
                <label for="no_hp" class="form-label block mb-2 text-sm font-medium"><i
                        class="fas fa-phone text-gray-400 mr-2"></i>Nomor
                    Telepon</label>
                <div class="input-with-icon">
            ...
            <div class="mb-5">
                <label for="pekerjaan" class="form-label block mb-2 text-sm font-medium"><i
                        class="fas fa-user text-gray-400 mr-2"></i>Pekerjaan</label>
        ...
        <div class="text-blue-700 mx-5  ">
            <div class="mb-5 relative">
                <label for="tanggal_janjian" class="form-label block mb-2 text-sm font-medium"> <i
                        class="fas fa-calendar-check text-gray-400 mr-2"></i>Tanggal Janjian</label>
                <div class="input-with-icon">
            ...
            <div class="mb-5 relative">
                <label for="waktu_janjian" class="form-label block mb-2 text-sm font-medium"> <i
                        class="fa-regular fa-clock text-gray-400 mr-2"></i>Waktu Janjian</label>
                <div class="input-with-icon">
            ...
            <div id="dropdown-section" class="mb-5">
                <label for="sumber_informasi" class="form-label block mb-2 text-sm font-medium">Dapat Informasi Dari
                    (Dropdown)</label>
            ...
            <div class="affiliate flex w-full gap-4" style="display: none;">
                <div class="w-full">
            ...
            <div class="sales  flex w-full gap-4" style="display: none;">
                <div class="w-full">
...
<script>
    ...
    // Script untuk show/hide dropdown berdasarkan sumber informasi
    document.addEventListener('DOMContentLoaded', function() {
        ...
        sumberInformasi.addEventListener('change', function() {
            ...
            if (value === 'Agent') {
                ...
                affiliateDiv.style.display = 'flex';
