    ...
    <section class="row">
        <div class="col card px-3 py-3">
            ...
            <div class="my-3 p-3 rounded">
                ...
                <form method="POST" action="{{ route('admin.updateSurvey', ['id' => $survey->id]) }}"
                    ...
                    <div class="mb-3" hidden>
                        ...
                        <input type="text" value="{{ $survey->user_id }}" name="user_id" id="user_id"
                            class="form-control">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="no_hp" name="no_hp" pattern="08[0-9]{8,}"
                            ...
                            oninput="validatePhoneNumber()" value="{{ $survey->no_hp }}">
                        ...
                        <div class="w-full">
                            ...
                            <select id="affiliate_id" name="affiliate_id"
                                ...
                                @foreach ($affiliate as $a)
                                    <option value="{{ $a->id }}"
                                        {{ isset($survey->affiliate_id) && $a->id == $survey->affiliate_id ? 'selected' : '' }}>
                                        {{ $a->name }} ({{ $a->code }})
                                    </option>
                                @endforeach
                            </select>
