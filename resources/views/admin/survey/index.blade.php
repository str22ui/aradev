@extends('admin.layouts.index', ['title' => 'Data Survey', 'page_heading' => 'Data Survey'])
...
<section class="row">
    ...
    <a href="{{ route('admin.createSurvey') }}">
        <button type="submit" class="btn btn-primary mr-2 mb-2">+Insert Data</button>
    </a>
    {{-- @endif --}}
    {{-- @if(auth()->user()->role === 'admin'|| Auth::user()->role == 'salesAdmin') --}}
    <form action="{{ url('survey/export/excel') }}" method="GET" class="d-flex justify-content-between align-items-center">
        <div>
    ...
    <div class="table-responsive">
        @include('admin.survey.tableSurvey', ['survey' => $survey])
    </div>
