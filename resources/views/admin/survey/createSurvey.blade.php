@extends('admin.layouts.index', ['title' => 'Tambah Survey', 'page_heading' => 'Tambah Data Survey'])
                ...
                <form method="post" action="{{ route('admin.storeSurvey') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="no_hp" name="no_hp" pattern="08[0-9]{8,}"
                            ...
                            oninput="validatePhoneNumber()" value="{{ old('no_hp') }}">
                    ...
                    <div class="mb-3">
                        <label for="waktu_janjian" class="form-label">Waktu Survey</label>
