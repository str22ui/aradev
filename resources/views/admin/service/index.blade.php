@extends('admin.layouts.index', ['title' => 'Data Services', 'page_heading' => 'Data Services'])
...
<section class="row">
	...
	<div class="my-3 p-3 rounded">
        ...
        <a href="{{ route('admin.createService') }}" class="btn btn-success me-2 py-2" >
            + Insert Data
        </a>
                ...
                @foreach ($service as $s)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.editService', ['id' => $s->id]) }}" class="btn btn-warning btn-sm">
                                <i class="bi bi-pencil-square"></i>
                            </a>
                            @if (auth()->user()->role !== 'salesAdmin')
                            <form onsubmit="return confirm('Apakah anda yakin ingin menghapus data?')" class="d-inline" action="{{ route('admin.deleteService') }}" method="POST">
                                @csrf
                                @method('DELETE')
