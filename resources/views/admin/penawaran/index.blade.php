...
<section class="row">
    ...
    <form action="{{ url('penawaran/export/excel') }}" method="GET" class="d-flex justify-content-between align-items-center">
        <div>
    ...
    <div class="table-responsive">
        @include('admin.penawaran.tablePenawaran', ['penawaran]' => $penawaran])
    </div>
