                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        <div class="card bg-info text-white">
                            <div class="card-body">
                                ...
                                <p class="mb-1"><strong>Kode:</strong> <code class="text-white">{{ $sales->code ?? $sales->email }}</code></p>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-warning text-dark">
                            <div class="card-body text-center">
                                <h1 class="display-4">{{ $affiliates->sum(function($aff) { return $aff->commissions->sum('total'); }) }}</h1>
                        ...
                        <tbody>
                            @forelse($affiliates as $index => $affiliate)
                                <tr>
                                    ...
                                    <td>
                                        <strong>Rp {{ number_format($affiliate->commissions->sum('total'), 0, ',', '.') }}</strong>
                                    </td>
                                    <td>
